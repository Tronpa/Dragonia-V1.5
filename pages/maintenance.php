...
<body data-background-color="dark">
	<div class="wrapper">
	<?php include('include/navbar-maintenance.php');?>	
		<div class="main-panel">
			...
			<div class="row">
				...
				<div class="col-md-9">
					<img height="100%" width="100%" src="https://cdn.shopify.com/s/files/1/0387/0841/files/maintenance-page-1.png?v=1492412938">
				</div>
